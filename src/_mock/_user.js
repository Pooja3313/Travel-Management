...
//   { value: 'company_pays', label: 'Company pays all trip expenses upfront' },
// ];
...
// export const _pay = [
//   { value: 'reimbursed', label: 'I will pay for the trip and get reimbursed later' },
//   { value: 'company_pay', label: 'Company pays all trip expenses upfront' },
// ];




export const _foodNeeded = [
  { value: 'yes', label: 'yes' },
  { value: 'no', label: 'no' },
];
...
export const _EmpList = [...Array(20)].map((_, index) => {
  ...
  return {
    ...
    accommodation:_mock.accommodation(index),
